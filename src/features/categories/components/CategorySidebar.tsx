...
export default function CategorySidebar({
  ...
  return (
    <div className="p-5 rounded-2xl bg-white border border-slate-200/80 shadow-sm flex flex-col gap-4">
      ...
      <div className="flex flex-col gap-1.5 max-h-[500px] overflow-y-auto pr-1 scrollbar-thin scrollbar-thumb-slate-200">
        {/* All Genres Link */}
        <Link
          href="/books"
